 ...
 */
package com.byron.library.db.util;
...
import com.byron.library.db.annotation.Transient;
import com.byron.library.db.entity.DBHashMap;
import com.byron.library.db.entity.PKPropertyEntity;
import com.byron.library.db.entity.PropertyEntity;
import com.byron.library.db.entity.TableInfoEntity;
    ...
    public static DBHashMap<String> getRowData(Cursor cursor) {
        if (cursor != null && cursor.getColumnCount() > 0) {
            ...
            for (int i = 0; i < columnCount; i++) {
                ((DBHashMap) hashMap).put(cursor.getColumnName(i), cursor.getString(i));
            }
            return hashMap;
        }
        return null;

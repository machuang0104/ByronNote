...
import com.byron.library.db.entity.DBHashMap;
import com.byron.library.db.entity.DBMapArrayList;
import com.byron.library.db.entity.DBMasterEntity;
import com.byron.library.db.entity.NVArrayList;
import com.byron.library.db.exception.DBException;
import com.byron.library.db.exception.DBNotOpenException;
import com.byron.library.db.util.DBAnnoUtils;
import com.byron.library.db.util.SqlBuilderFactory;
import com.byron.library.db.util.sql.SqlBuilder;
...
public class SQLiteDBManager {
    ...
    // 数据库默认设置
    public final static String DB_NAME = AppConfig.DB_NAME;
        ...
        if (queryCursor != null) {
            try {
                ...
                while (queryCursor.moveToNext()) {
                    ((DBMapArrayList) arrayList).add(DBAnnoUtils.getRowData(queryCursor));
                }
            } catch (Exception e) {
                e.printStackTrace();

package com.byron.library.swipe.adapter;

import android.view.View;
import android.view.ViewGroup;
import android.widget.BaseAdapter;

import com.byron.library.swipe.DeleteListener;
import com.byron.library.swipe.Mode;
import com.byron.library.swipe.SwipeLayout;
import com.byron.library.swipe.implement.SwipeItemMangerImpl;
import com.byron.library.swipe.interfaces.SwipeAdapterInterface;
import com.byron.library.swipe.interfaces.SwipeItemMangerInterface;
...
public abstract class BaseSwipeAdapter extends BaseAdapter implements
    ...
    /**
     * return the {@link } resource id, int the
     * view item.
     *
     * @param position
     * @return
